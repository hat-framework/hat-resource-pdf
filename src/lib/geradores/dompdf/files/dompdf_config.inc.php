...
DOMPDF_autoload("Cellmap");

DOMPDF_autoload("Frame");
DOMPDF_autoload("Frame_Factory");

DOMPDF_autoload("Frame_Decorator");
DOMPDF_autoload("Block_Frame_Decorator");
DOMPDF_autoload("Page_Frame_Decorator");
DOMPDF_autoload("Text_Frame_Decorator");
DOMPDF_autoload("Table_Frame_Decorator");
DOMPDF_autoload("Table_Cell_Frame_Decorator");
DOMPDF_autoload("Table_Row_Frame_Decorator");
DOMPDF_autoload("Table_Row_Group_Frame_Decorator");
DOMPDF_autoload("Inline_Frame_Decorator");

DOMPDF_autoload("Frame_Reflower");
DOMPDF_autoload("Block_Frame_Reflower");
DOMPDF_autoload("Page_Frame_Reflower");
DOMPDF_autoload("Text_Frame_Reflower");
DOMPDF_autoload("Table_Frame_Reflower");
DOMPDF_autoload("Table_Cell_Frame_Reflower");
DOMPDF_autoload("Table_Row_Frame_Reflower");
DOMPDF_autoload("Table_Row_Group_Frame_Reflower");
DOMPDF_autoload("Inline_Frame_Reflower");

DOMPDF_autoload("Frame_Tree");

DOMPDF_autoload("Canvas");
DOMPDF_autoload("CPDF_Adapter");

DOMPDF_autoload("Canvas_Factory");

DOMPDF_autoload("Font_Metrics");
DOMPDF_autoload("Abstract_Renderer");
DOMPDF_autoload("Renderer");
DOMPDF_autoload("Block_Renderer");
DOMPDF_autoload("Text_Renderer");
DOMPDF_autoload("Table_Cell_Renderer");
DOMPDF_autoload("Inline_Renderer");

DOMPDF_autoload("Positioner");
DOMPDF_autoload("Block_Positioner");
DOMPDF_autoload("Inline_Positioner");
DOMPDF_autoload("Null_Positioner");
DOMPDF_autoload("Table_Cell_Positioner");

DOMPDF_autoload("Style");
DOMPDF_autoload("Stylesheet");
DOMPDF_autoload("Attribute_Translator");

DOMPDF_autoload("Image_Cache");

DOMPDF_autoload("DOMPDF_Exception");
