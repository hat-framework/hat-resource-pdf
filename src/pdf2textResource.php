...
class pdf2textResource extends \classes\Interfaces\resource {
	// Some settings
	...
	private function setFilename($filename) {
        ...
        //imprime o texto traduzido ou o retorna
	public function PrintOutput() {
                echo $this->decodedtext;
	}

	public function decodePDF($filename, $unicode = true) {
            
                //zera o texto e seta o nome do arquivo
